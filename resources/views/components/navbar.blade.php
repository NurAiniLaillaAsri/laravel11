<nav class="bg-gray-800" x-data="{ isOpen: false }"> {{-- tambah x-data="{ isOpen: false }" di sini untuk toggle --}}
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="flex h-16 items-center justify-between">
            ...
            <div class="hidden md:block">
              ...
              -->
                        <div {{-- Atur Transitions --}} x-show="isOpen"
                            ...
                            <a href="/myarticle" class="block px-4 py-2 text-sm text-gray-700" role="menuitem"
                                tabindex="-1" id="user-menu-item-0">My Article</a>
            ...
            <div class="-mr-2 flex md:hidden">
                ...
                <button type="button" @click="isOpen = !isOpen"
                    ...
                    {{-- tambah Dynamic classes dengan :class="{'hidden': isOpe, 'block': !isOpen }" --}}
                    <svg :class="{ 'hidden': isOpe, 'block': !isOpen }" class="block h-6 w-6" fill="none"
                        viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
                        <path stroke-linecap="round" stroke-linejoin="round"
                            d="M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25h16.5" />
                    </svg>
                    <!-- Menu open: "block", Menu closed: "hidden" -->
                    <svg :class="{ 'block': isOpe, 'hidden': !isOpen }" class="hidden h-6 w-6" fill="none"
                        viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">

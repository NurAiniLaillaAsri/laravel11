<x-layout>
    <x-slot:title>{{ $title }}</x-slot:title> {{-- $title di sini mengambil dari route  --}}
        ...
        <div class="flex justify-between px-4 mx-auto max-w-screen-xl ">
            <article
                ...
                <header class="mb-4 lg:mb-6 not-format">
                    ...
                    <address class="flex items-center mt-3 mb-6 not-italic">
                        <div class="inline-flex items-center mr-3 text-sm text-gray-900 dark:text-white">
                            <img class="mr-4 w-16 h-16 rounded-full"
                                src="https://flowbite.com/docs/images/people/profile-picture-2.jpg" alt="{{ $post->author->name }}">
                            <div>
                                <a href="/posts?category={{ $post->category->slug }}"><span class="bg-{{ $post->category->color }}-100 text-primary-800 text-xs font-medium inline-flex items-center px-1.5 py-0.5 rounded dark:bg-primary-200 dark:text-primary-800 hover:underline">
                                    {{ $post->category->name }}
                                </span></a><br>
            ...
            <div class="grid gap-12 sm:grid-cols-2 lg:grid-cols-4">
                ...
                <article class="max-w-xs">
                    ...
                    <a href="/categories/{{ $post->category->slug }}"><span
                        class="bg-{{ $post->category->color }}-100 text-primary-800 text-xs font-medium inline-flex items-center px-0.5 py-0.5 rounded dark:bg-primary-200 dark:text-primary-800 hover:underline">
                        {{ $post->category->name }}
                    </span></a>
                    <h2 class="mb-2 text-xl font-bold leading-tight text-gray-900 dark:text-white">
                        <a href="/posts/{{ $post['slug'] }}">{{ Str::limit($post['title'], 30) }}</a>
                    </h2>
                    <p class="mb-4 text-gray-500 dark:text-gray-400">{{ Str::limit($post['body'], 80) }}</p>
                    <a href="/posts/{{ $post['slug'] }}"
